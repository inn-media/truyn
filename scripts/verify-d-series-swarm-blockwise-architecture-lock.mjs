...
const requiredTrue = [
  'swarmOwnsDiagnosticsAndRepair','blockwiseMayNotReplaceSwarm','fullBlockwiseRequiresCleanExactShaSwarm','targetedBlockGreenIsNotLaunchAuthorization','realScaleRunRequiresAdmission','realScaleRunIsSingleShot','acceptanceThresholdWeakeningForbidden','silentArchitectureReplacementForbidden','expensiveQualificationBelongsToFrozenCandidate','historicalEvidenceBoundToImmutableRunSha','mainMovementTriggersAdmissionAnalysisNotAutomaticFullRerun','candidateEvidenceSurvivesNonSensitiveMainMovement','sensitiveMainMovementRequalifiesOnlyAffectedBlocksByDefault','integrationCandidateFingerprintsMandatoryBeforeMerge','greenCandidateShaAloneNeverAuthorizesMerge','freshAdmissionMandatoryAfterEveryMainMovement','automaticFullRerunOnMainMovementForbidden','admissionPolicyCannotBeBypassedOrSilentlyRemoved'
];
...
console.log('TRUYN_D_SERIES_ARCHITECTURE_LOCK=PASS primary=sanitation-swarm admission=blockwise-b01-b16 qualification=frozen-candidate evidence-binding=immutable-run-sha lifetime=ALL_D_SERIES_TESTS_COMPLETE');
