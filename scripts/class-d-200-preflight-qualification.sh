...
node --test tests/d200-canonical-regressions.test.js tests/d200-anti-weakening.test.js tests/d200-staging-robustness.test.js tests/d200-peer-propagation-readiness-barrier.test.js tests/d200-route-repair-acceptance-invariants.test.js tests/d200-stage-isolation.test.js tests/class-d-canonical-pin-regression.test.js tests/class-d-accepted-entrypoint-regression.test.js
printf 'TRUYN_D200_PREFLIGHT_QUALIFICATION=PASS canonical_source=true runtime_patching=false stage_isolation=true\n'
