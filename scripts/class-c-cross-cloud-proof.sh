...
curl -fsSL "https://raw.githubusercontent.com/inn-media/truin/${BASE_COMMIT}/scripts/class-c-cross-cloud-proof.sh" -o "$HARNESS"
sed -i 's#github.com/inn-media/truin/#github.com/inn-media/truyn/#g' "$HARNESS"
