...
- Updated `README.md`, `MANIFESTO.md`, `CONTRIBUTING.md`, `STRUCTURE.md`, `docs/README.md`, `ARCHITECTURE_CONTRACT.md` and `IMPLEMENTATION_STATUS.md` so governance is part of the project DNA/source-of-truth hierarchy rather than an optional community appendix.
