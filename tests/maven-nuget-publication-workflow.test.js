...
test('registry coordinate state tracks accepted evidence independently', async () => {
  ...
  // Maven remains open until its own immutable public evidence exists.
  assert.equal(coords.maven.publicationState, 'open');

  // NuGet alpha.1 is accepted only together with committed independent evidence.
