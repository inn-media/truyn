...
- Package build/provenance does not by itself prove public registry availability; npm alpha.2, PyPI alpha and Go alpha are separately accepted from observed immutable public evidence, while NuGet.org `Truyn.Sdk 0.1.0-alpha.1` is an accepted immutable public prerelease; Maven Central remains open.
