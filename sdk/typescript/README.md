...
**Status:** implemented Developer Release client; source/build complete, pre-stable, and accepted as immutable public npm prerelease `@truyn/sdk@0.1.0-alpha.2` with registry byte identity, provenance/signature evidence and independent clean-room Node 22 ESM verification.
...
Ordinary CI builds/verifies the npm release artifact and records exact source SHA, byte size and SHA-256 provenance. The accepted public npm alpha.2 release remains pre-stable; stable release status is a separate gate.
