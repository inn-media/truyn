...
All benchmark families additionally bind to `../benchmarks/BENCHMARK_SERIES_ISOLATION.md`; unrelated series must be able to run concurrently on disjoint resources without cancellation, namespace collision or cleanup interference.
