...
- [`H_SERIES_STATUS.md`](H_SERIES_STATUS.md) — current H-Series lane status; H/ARBITRAGE is PASS/CLOSED while CACHE, SECOND-OPINION and CHAOS-FUZZ remain pending final.
