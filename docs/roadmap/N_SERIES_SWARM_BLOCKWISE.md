...
These rules are machine locked by `config/n-series-swarm-blockwise-architecture-lock.json` and the existing N frozen-candidate qualification/admission tests. They must not be weakened or bypassed.
